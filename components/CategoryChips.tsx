...
const CategoryChips = ({
  ...
  videoData: Video[];
  categorySetterFunc: (categoryName: string) => void;
  category: string | null;
}) => {
  return (
    <div className="sticky top-14 z-10 flex h-fit items-center gap-4 bg-white bg-opacity-95 px-2 py-2 pt-4 dark:bg-dark-background sm:overflow-x-scroll md:overflow-auto">
