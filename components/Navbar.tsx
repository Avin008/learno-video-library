    ...
    <div className="fixed left-0 right-0 top-0 z-40 flex h-16 items-center justify-between border-b bg-white shadow-md dark:border-dark-border dark:bg-dark-background sm:px-4 lg:px-8">
      ...
      >
        {loading ? (
          ...
          <li
            className={`flex items-center gap-1 rounded-md border border-gray-500 px-3 py-2 text-sm font-medium shadow-md hover:cursor-pointer dark:border-dark-border dark:text-white`}
            onClick={removeAuth}
          >
          ...
          <Link href="/login">
            <li
              className={`flex items-center gap-1 rounded-md border px-3 py-2 text-sm font-medium shadow-md hover:cursor-pointer dark:border-dark-border dark:text-white ${
