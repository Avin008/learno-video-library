  ...
  return (
    <div className="grid grid-cols-7 gap-3">
      ...
      <div className="col-span-4 space-y-1">
        <h1 className="text-sm font-semibold leading-5 text-gray-300 sm:hidden md:block">
          {videoData.title.length > 50
            ? `${videoData.title.slice(0, 50)}...`
            : videoData.title}
        </h1>
        <h1 className="text-sm font-semibold leading-5 text-gray-300 sm:block md:hidden">
